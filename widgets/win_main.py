...
class WinMain(UMainWindow):
    ...
    def setup_signals(self):
        ...
        self.bar_top.base_signals.level_up.connect(self.level_up)
        self.bar_top.base_signals.change_view.connect(self.change_view_cmd)
        self.bar_top.base_signals.load_st_grid.connect(self.load_st_grid)
        self.bar_top.base_signals.new_main_win.connect(self.new_main_win_open)
    ...
    def level_up(self):
        ...
        if new_main_dir != os.sep:
            ...
            self.main_win_item.go_to_widget = self.main_win_item.abs_current_dir
    ...
    def load_st_grid(self, path: str):
        ...
        if self.main_win_item.set_current_dir(path):
            ...
            QTimer.singleShot(100, show_no_path_win)
