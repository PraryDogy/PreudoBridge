...
class About(QGroupBox):
    ...
    def __init__(self):
        ...
        svg_ = USvgSqareWidget(os.path.join(Static.app_icons_dir, "icon.svg"), About.svg_size)
...
class Themes(QGroupBox):
    ...
    def __init__(self):
        ...
        self.system_theme = SvgFrame(os.path.join(Static.app_icons_dir, "theme_sys.svg"), self.system_text)
        self.dark_theme = SvgFrame(os.path.join(Static.app_icons_dir, "theme_dark.svg"), self.dark_text)
        self.light_theme = SvgFrame(os.path.join(Static.app_icons_dir, "theme_light.svg"), self.light_text)
